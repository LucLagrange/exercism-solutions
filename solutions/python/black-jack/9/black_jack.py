...
def higher_card(card_one, card_two):
    ...
    if value_card_one == value_card_two:
        value_higher_card = (card_one, card_two)
    elif value_card_one > value_card_two:
        value_higher_card = card_one
    else:
        value_higher_card = card_two
    return value_higher_card
...
def is_blackjack(card_one, card_two):
    ...
    return 'A' in hand and len(set(face_cards) & set(hand)) > 0
...
def can_split_pairs(card_one, card_two):
    ...
    return hand == ['Q', 'K'] or card_one == card_two
